    ...
    "summary": {
        ...
        "dev": 0.017482
			...
			regexes: []*regexp.Regexp{
				...
				regexp.MustCompile(`ceph_osd_bytes_used{osd="osd.0"} 4.0772e`),
				regexp.MustCompile(`ceph_osd_bytes_used{osd="osd.1"} 4.0512e`),
				regexp.MustCompile(`ceph_osd_bytes_used{osd="osd.2"} 3.6712e`),
				regexp.MustCompile(`ceph_osd_bytes_used{osd="osd.3"} 3.6784e`),
				regexp.MustCompile(`ceph_osd_bytes_avail{osd="osd.0"} 1.1109544e`),
				regexp.MustCompile(`ceph_osd_bytes_avail{osd="osd.1"} 1.1109804e`),
				regexp.MustCompile(`ceph_osd_bytes_avail{osd="osd.2"} 1.1113604e`),
				regexp.MustCompile(`ceph_osd_bytes_avail{osd="osd.3"} 1.1113532e`),
				...
				regexp.MustCompile(`ceph_osd_total_bytes_used 1.5478e`),
				regexp.MustCompile(`ceph_osd_total_bytes_avail 4.4446484e`),
